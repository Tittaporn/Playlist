...
/*
 ...
 //We don't need this anymore because songs in Playlist
 ...
 // CRUD Methods
 //Create a song and add to songs
 func createSong(newSongtitle: String, newSongArtist: String, playlist: Playlist) {
 
 // create a song
 let newSong = Song(title: newSongtitle, artist: newSongArtist)
 
 //We add new parameter playlist: Playlist, append to playlist
 playlist.songs.append(newSong)
 ...
 //Delete
 func deleteSong(songToDelete: Song, playlist: Playlist) {
 ...
 */
 /* We don't need to savePersistance because we have PlayList
